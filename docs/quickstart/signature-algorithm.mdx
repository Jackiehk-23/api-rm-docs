...
<ParamTable
  ...
  rows={[
    { name: "data", type: "String", required: true, description: "Base64-encoded data body from Step 2.", example: "(See Step 2 output)", anchor: "#step-2--base64-encode-the-data" },
