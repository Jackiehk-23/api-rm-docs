...
<ParamTable
  ...
  rows={[
    { name: "item", type: "Object", description: "Response item",
      children: [
      { name: "id", type: "String", description: "Tokenized customer ID" },
      ...
      { name: "productName", type: "String", description: "Tokenized product name" },
      { name: "productDescription", type: "String", description: "Tokenized product description" },
      { name: "isActive", type: "Boolean", description: "Whether the token is active. Becomes true after card is bound successfully." },
