...
<img src={require('/img/plugin/example-plugin.png').default}  />
...
<CodeBlock language="go" filename="Signature Verification">
{`package main
import (
	"crypto/hmac"
	"crypto/sha256"
...
<CodeBlock language="json" filename="Decoded Payload">
{`{
...
<CodeBlock language="js" filename="Initialize Handshake">
