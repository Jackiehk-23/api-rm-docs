...
<ParamTable
  ...
  rows={[
    ...
    { name: "amount", type: "Integer", required: true, description: "Transaction amount to calculate loyalty points earned.", example: "100" },
...
<CodeBlock language="json" filename="Example Request Member ID">
...
<CodeBlock language="json" filename="Example Response (QR Code)">
{`{
  "item": {
