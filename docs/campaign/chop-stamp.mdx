...
<img src={require('/img/campaign/chop-stamp.png').default} alt="images" />
  ...
  rows={[
    { name: "item", type: "Object", description: "Transaction object",
      children: [
        ...
        { name: "noOfChoppedStamp", type: "Integer", description: "Number of redeem", example: "2" },
        { name: "isCompleted", type: "Boolean", description: "True or False", example: "false" },
