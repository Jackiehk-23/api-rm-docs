  ...
  rows={[
    ...
    { name: "order", type: "Object", required: true, description: "Object of order",
      children: [
        ...
        { name: "details", type: "String", required: true, description: "Order details, max: 600", example: "\"1 x iPhone X; 2 x SAMSUNG S8\"" },
        { name: "additionalData", type: "String", required: true, description: "For merchant's remark, max 128", example: "\"\"" },
    ...
    { name: "extraInfo", type: "Object", description: "Object of extra Info",
      children: [
        { name: "type", type: "String", required: true, description: "Membership", example: "\"MEMBERSHIP\"" },
        { name: "reference", type: "String", required: true, description: "Member Card ID", example: "\"28158443195878043074\"" }
      ]},
    { name: "ipAddress", type: "String", required: true, description: "IP address of terminal/application for payment", example: "\"8.8.8.8\"" },
...
<img src="/img/developer-application/8.png" />
